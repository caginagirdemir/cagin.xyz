...
/***/ function(module, exports, __webpack_require__) {
	...
	const GameView = function(ctx, canvasSize, signer, tokenContract, gameContract) {
		this.ctx = ctx;
	...
	GameView.prototype.gameOver = function() {
	  ...
	  setTimeout(() => {
		...
		EndButtonGame.innerText = "Submit Score"
	...
	GameView.prototype.handleKeyDown = async function(e) {
	  if (e.keyCode === 37) {
